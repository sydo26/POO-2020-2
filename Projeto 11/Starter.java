...
public class Starter {
  ...
  public Starter(AgendaPlus agenda, Scanner scanner) {
    this.agenda = agenda;
  ...
  protected void unstar() throws ExceptionControl {
    String name = this.scanner.next();
    if (agenda.getContato(name) == null)
      throw new ExceptionControl("não foi possível encontrar o contato [" + name + "]");

    agenda.unStarContato(name);
  }

  protected void star() throws ExceptionControl {
    String name = this.scanner.next();
    if (agenda.getContato(name) == null)
      throw new ExceptionControl("não foi possível encontrar o contato [" + name + "]");

    agenda.starContato(name);

  }

  protected void starred() {
    agenda.show(agenda.getStarreds());
  }
